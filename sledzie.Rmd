...
Można przypuszczać, że oddziaływanie zarówno sst działa na długość śledzia z pewnym opóźnieniem, stąd pewne nieścisłości w wykresie.
...
min_fbar <- min(mean_length_month[,'fbar'])
max_fbar <- max(mean_length_month[,'fbar'])
